...
window.addEventListener("DOMContentLoaded",function(){
	...
	xhr.open("post","http://localhost:8090/user/getUserInfo",true);
...
<div class="a">
  ...
  <div class="user_info">
    ...
    <div class="user_update_form">
      ...
      <label for="">이메일 : <input type="text" id="email" name="email" value=""><button onclick="update_address()">수정</button></label><br>
      <label for="">휴대폰 : <input type="tel" id="phone" name="phone" value=""><button onclick="update_address()">수정</button></label>
